...
public class CarProfile extends BaseActivity {
    ...
    int counter=0;
    String carNumber, carSeats, carPrice, from, to, date, time, phonenumber;
        ...
        btnSaveCar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (carNumber.trim().equals(""))
                    ...
                    mDatabase.child("car owner").child("owner"+counter).child("image")
                            .setValue("http://www.orangeandhoney.com/ChatPublico/img/icon_user.png");
