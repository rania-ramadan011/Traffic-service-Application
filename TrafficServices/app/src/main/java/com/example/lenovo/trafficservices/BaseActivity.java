...
public class BaseActivity extends AppCompatActivity { //changed from depricated ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabase = FirebaseDatabase.getInstance().getReference().child("users").child(mUserId).child("image");
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 1:
                ...
                break;
            case 2:
                Intent intent1 = new Intent(this, MapDirections.class);
            ...
            case 8:
                ...
                break;
            case 9:
                Intent intent9 = new Intent(this, TravelActivity.class);
